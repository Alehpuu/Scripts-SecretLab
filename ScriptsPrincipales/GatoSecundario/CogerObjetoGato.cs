...
public class CogerObjetoGato : MonoBehaviour
{
    public GameObject bocaPoint;
    private GameObject pickedObject = null;
    private bool isHoldingObject = false;
    public float maxDistance = 6f; // Distancia máxima de recogida
    ...
    private void RecogerObjeto()
    {
        ...
        {
            if (_hit.collider.CompareTag("Objeto4") || _hit.collider.CompareTag("Objeto5") || _hit.collider.CompareTag("ObjetoCora"))
            {
                ...
                pickedObject.transform.position = bocaPoint.transform.position; // Ajustar la posición donde se coloca el objeto recogido
                pickedObject.transform.SetParent(bocaPoint.transform);
